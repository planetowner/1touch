...
// 짧은 이름은 diagnostics/team_short_names.json과 같은 샘플이에요. API 응답이 있으면 DB 값을 써요.
const mockTeams = <Team>[
  ...
  Team(teamId: 117, name: "Coventry City", shortName: 'Conventry'),
  Team(teamId: 22, name: "Hull City", shortName: 'Hull City'),
  Team(teamId: 3588, name: "Elversberg", shortName: 'Elversberg'),
  Team(teamId: 2642, name: "Paderborn", shortName: 'Paderborn'),
  Team(teamId: 67, name: "Schalke 04", shortName: 'Schalke'),
  Team(teamId: 7758, name: "Le Mans", shortName: 'Le Mans'),
  Team(teamId: 7047, name: "Troyes", shortName: 'Troyes'),
  Team(teamId: 4070, name: "Frosinone", shortName: 'Frosinone'),
  Team(teamId: 429, name: "Deportivo A Coruña", shortName: 'Deportivo'),
  Team(teamId: 126, name: "Málaga", shortName: 'Malaga'),
  Team(teamId: 9818, name: "Racing Santander", shortName: 'R Santandr'),
];
