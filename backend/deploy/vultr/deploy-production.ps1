...
$outputPath = Join-Path $backendPath "logs\lightsail-releases\$releaseTag"
$remotePath = "/home/ubuntu/onetouch-transfer/production/$releaseTag"
...
Write-Host '2/3. 코드를 서울 Lightsail 서버에 전송해요.'
...
Write-Host '3/3. 서울 Lightsail 서버에 HTTPS와 운영 설정을 적용해요.'
