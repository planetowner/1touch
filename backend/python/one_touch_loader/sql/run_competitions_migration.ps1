...
$sqlPath = Join-Path $PSScriptRoot 'migrate_leagues_to_competitions.sql'
...
$backupPath = Join-Path $backupDirectory 'before_competitions_migration.sql'
...
try {
    ...
    Write-Host 'Competitions migration completed.'
